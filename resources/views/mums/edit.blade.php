        ...
        <div class="col-md-10 col-md-offset-1">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-lg fa-address-book text-danger"></i>
                    <strong class="text-danger">แก้ไข</strong>
                    <strong>
                ...
                <div class="panel-body">
                    <form class="form-horizontal" name="themum" method="POST" action="{{route('mums.update', ['id_mum' => $mums->id_mum])}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('name_mum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name_mum" type="text" class="form-control" name="name_mum" value="{{ $mums->name_mum }}">
                        ...
                        <div class="form-group{{ $errors->has('crad') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="crad" type="text" class="form-control" name="crad" value="{{ $mums->crad }}">
                        ...
                        <div class="form-group{{ $errors->has('profession_mum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="profession_mum" type="text" class="form-control" name="profession_mum" value="{{ $mums->profession_mum }}">
                        ...
                        <div class="form-group{{ $errors->has('religion_mum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="religion_mum" type="text" class="form-control" name="religion_mum" value="{{ $mums->religion_mum }}">
                        ...
                        <div class="form-group{{ $errors->has('study_mum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="study_mum" type="text" class="form-control" name="study_mum" value="{{ $mums->study_mum }}">
                        ...
                        <div class="form-group{{ $errors->has('tel_mum') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tel_mum" type="text" class="form-control" name="tel_mum" value="{{ $mums->tel_mum }}">
                        ...
                        <div class="form-group{{ $errors->has('name_fathter') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="name_fathter" type="text" class="form-control" name="name_fathter" value="{{ $mums->name_fathter }}">
                        ...
                        <div class="form-group{{ $errors->has('crad_father') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="crad_father" type="text" class="form-control" name="crad_father" value="{{ $mums->crad_father }}">
                        ...
                        <div class="form-group{{ $errors->has('profession_fathter') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="profession_fathter" type="text" class="form-control" name="profession_fathter" value="{{ $mums->profession_fathter }}">
                        ...
                        <div class="form-group{{ $errors->has('religion_fathter') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="religion_fathter" type="text" class="form-control" name="religion_fathter" value="{{ $mums->religion_fathter }}">
                        ...
                        <div class="form-group{{ $errors->has('study_fathter') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="study_fathter" type="text" class="form-control" name="study_fathter" value="{{ $mums->study_fathter }}">
                        ...
                        <div class="form-group{{ $errors->has('tel_fathter') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="tel_fathter" type="text" class="form-control" name="tel_fathter" value="{{ $mums->tel_fathter }}">
                        ...
                        <div class="form-group{{ $errors->has('address') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <textarea id="address" type="text" class="form-control"     name="address" value="{{ $mums->address }}"> {{ $mums->address }}
                                </textarea>
                        ...
                        <div class="form-group{{ $errors->has('zipcod') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="zipcod" type="text" class="form-control" name="zipcod" value="{{ $mums->zipcod }}">
